#!/usr/bin/env python3
"""
Example usage of the Notary Invoice Generator - Windows Version
"""
...
pdf_file = generator.generate_pdf(invoice_data, 'example_loan_signing_windows.pdf')
...
invoice_data = generator.create_invoice(client_info, services)
pdf_file = generator.generate_pdf(invoice_data, 'example_general_notarization_windows.pdf')
print(f"✓ Created: {pdf_file}")
...
pdf_file = generator.generate_pdf(invoice_data, 'example_after_hours_windows.pdf')
print(f"✓ Created: {pdf_file}")

print("\n✓ All example invoices generated successfully!")
print("\nFiles created:")
print("  - example_loan_signing_windows.pdf")
print("  - example_general_notarization_windows.pdf")
print("  - example_after_hours_windows.pdf")
